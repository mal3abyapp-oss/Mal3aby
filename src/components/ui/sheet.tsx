...
>(({ side = "right", className, children, ...props }, ref) => {
  ...
  // this sr-only label was hardcoded English ("Close") with no i18n
  // wired in at all -- same root cause and fix as dialog.tsx's
  // DialogContent, applied here since Sheet is a separate shared
  // primitive with its own duplicate close button.
