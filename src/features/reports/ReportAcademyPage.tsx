...
export function ReportAcademyPage() {
  ...
  return (
    <div>
      <PageHeader title="التقارير" description="تقرير الأكاديمية -- التسجيلات والحضور والاشتراكات المنتهية قريبًا" />
      <ReportsNav />
      ...
      {data && (
        <>
          <div className="mb-6 grid grid-cols-2 gap-3 md:grid-cols-3">
            <StatCard label="التسجيلات النشطة" value={data.active_enrollments} icon={GraduationCap} to="/app/academy" />
