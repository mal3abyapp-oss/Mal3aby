...
`Scan` is given a prominent, thumb-reachable center position — it's a high-frequency action for reception/gate staff.
...
Cash Shift open/close, Expenses entry, Utilization Heatmap, Organizations admin, Customer self-service portal. See [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md#v1--deferred-matrix).
