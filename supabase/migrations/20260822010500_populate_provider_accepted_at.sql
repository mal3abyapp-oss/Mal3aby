-- Companion to 20260822010000: populates the new provider_accepted_at
-- column on the existing success path of whatsapp_connector_report_send_result()
-- -- no other logic changed. This is the honest label for what this
-- function's success branch has always actually proven (our own
-- outbound socket write completed), now given its own explicit
-- timestamp column instead of being conflated with real delivery.
